...
(function () {
  ...
  DICTS.es = {
    ...
    "pre.off": "Desactivado (0s)", "pre.3": "3 s", "pre.5": "5 s", "pre.10": "10 s",
    ...
    "p1": "⚡ HIIT", "p2": "🧘 Descanso", "p3": "💪 Plancha",
    "p4": "🥊 Asalto de boxeo", "p5": "☕ Café / Té", "p6": "🍅 Pomodoro",
    ...
    "snd.alarm": "Alarma deportiva digital 🚨", "snd.chime": "Campanillas de marimba ✨",
  ...
  DICTS.de = {
    ...
    "tt.language": "App- & Sprach-Sprache",
    ...
    "st.getready": "FERTIG MACHEN", "st.timesup": "ZEIT ABGELAUFEN!",
    "overlay.getready": "Fertig machen",
    "btn.reset": "Zurücksetzen", "btn.clear": "Leeren", "btn.lap": "Runde",
    ...
    "p1": "⚡ HIIT", "p2": "🧘 Pause", "p3": "💪 Planke",
    "p4": "🥊 Boxrunde", "p5": "☕ Kaffee / Tee", "p6": "🍅 Pomodoro",
    ...
    "modal.language.title": "App- & Sprach-Sprache",
    ...
    "set.sectionTimer": "Timer läuft",
    "set.wakelock": "Bildschirm anlassen",
    "set.wakelockDesc": "Display bleibt an, während der Timer läuft",
    ...
    "set.language": "App- & Stimmensprache",
    ...
    "snd.whistle": "Schiri-Pfiffe 📢", "snd.bell": "Boxgong 🥊",
    "snd.alarm": "Digitaler Sportalarm 🚨", "snd.chime": "Sanftes Marimba-Spiel ✨",
    ...
    "sp.test": "Dies ist ein Test der Stimme deines Timers. Auf die Plätze, fertig, los!"
  };
  ...
  DICTS.fr = {
    ...
    "tt.language": "Langue de l'app et de la voix",
    ...
    "tab.timer": "Minuteur",
    "tab.stopwatch": "Chrono",
    "st.ready": "PRÊT", "st.running": "EN COURS", "st.paused": "PAUSE",
    "st.getready": "PRÉPARATION", "st.timesup": "TEMPS ÉCOULÉ !",
    "overlay.getready": "À vos marques",
    ...
    "p1": "⚡ HIIT", "p2": "🧘 Récupération", "p3": "💪 Gainage",
    "p4": "🥊 Round de boxe", "p5": "☕ Café / Thé", "p6": "🍅 Pomodoro",
    ...
    "modal.language.title": "Langue de l'app et de la voix",
    ...
    "set.wakelockDesc": "Écran actif pendant que le minuteur tourne",
    "set.speakEvents": "Annoncer les événements",
    "set.speakEventsDesc": "Annonce démarrage, pause, reprise et remise à zéro",
    ...
    "set.language": "Langue de l'app et de la voix",
    ...
    "snd.whistle": "Sifflet d'arbitre 📢", "snd.bell": "Cloche de boxe 🥊",
    ...
    "sp.test": "Voici un test de la voix de votre minuteur. À vos marques, prêts, partez !"
  };

  /* ============================ RUSSIAN ============================ */
  DICTS.ru = {
    "app.title": "Таймер с голосом",
    "tt.mute": "Вкл./выкл. звук и речь",
    ...
    "snd.alarm": "Цифровой спортивный сигнал 🚨", "snd.chime": "Нежный маримба-перезвон ✨",
    ...
    "sp.test": "Это проверка голоса вашего таймера. На старт, внимание, марш!"
  };

  /* ============================ MANDARIN CHINESE ============================ */
  DICTS.zh = {
    "app.title": "语音计时器",
    "tt.mute": "静音/取消静音语音与音效",
    "tt.language": "应用与语音语言",
    "tt.themes": "颜色主题",
    "tt.fonts": "显示字体",
    "tt.fullscreen": "全屏模式",
    ...
    "tab.timer": "计时器",
    "tab.stopwatch": "秒表",
    "st.ready": "就绪", "st.running": "运行中", "st.paused": "已暂停",
    "st.getready": "准备", "st.timesup": "时间到！",
    "overlay.getready": "预备",
    "btn.reset": "重置", "btn.clear": "清空", "btn.lap": "计次",
    "hint.tapset": "点按数字自定义时长",
    ...
    "presets.title": "快速预设",
    "presets.save": "保存当前",
    "p1": "⚡ HIIT", "p2": "🧘 休息", "p3": "💪 平板支撑",
    "p4": "🥊 拳击回合", "p5": "☕ 咖啡 / 茶", "p6": "🍅 番茄钟",
    "sw.unitsline": "分 : 秒 . 百分之一秒",
    "sw.speakLapTime": "播报单圈时间",
    "sw.speakLapTotal": "播报累计时间",
    "sw.vibrateLaps": "计次与间隔时震动",
    "stats.fastest": "最快", "stats.slowest": "最慢", "stats.totalLaps": "总圈数",
    "laps.empty": "还没有记录任何一圈",
    ...
    "set.sectionTimer": "计时器运行中",
    "set.wakelock": "保持屏幕常亮",
    "set.wakelockDesc": "计时器运行期间屏幕不熄灭",
    "set.speakEvents": "播报事件",
    "set.speakEventsDesc": "开始、暂停、继续和重置时语音提示",
    "set.metronome": "节拍器滴答",
    "set.metronomeDesc": "每秒轻微的滴答声",
    "set.sectionVoice": "语音合成引擎",
    "set.voiceOutput": "语音输出",
    ...
    "set.pitch": "音调",
    "set.testvoice": "试听语音",
    "set.sectionExpired": "计时结束",
    "set.completeSound": "结束提示音",
    "snd.whistle": "裁判哨声 📢", "snd.bell": "拳击台铃 🥊",
    "snd.alarm": "电子运动警报 🚨", "snd.chime": "轻柔马林巴琴 ✨",
    "snd.none": "静音 / 仅语音 🔇",
    "set.speakText": "播报文本",
    "set.openQR": "扫码在手机上打开",
    "kp.title": "设置时长",
  ...
  DICTS.ro = {
    ...
    "tt.mute": "Dezactivare/activare voce și sunet",
    ...
    "st.ready": "GATA", "st.running": "ÎN DERULARE", "st.paused": "PAUZĂ",
    ...
    "int.5": "5 s", "int.10": "10 s", "int.15": "15 s", "int.30": "30 s", "int.60": "1 min", "int.120": "2 min", "int.300": "5 min",
    "presets.title": "Presete rapide",
    "presets.save": "Salvează curentul",
    "p1": "⚡ HIIT", "p2": "🧘 Pauză de recuperare", "p3": "💪 Plank",
    "p4": "🥊 Tură de box", "p5": "☕ Cafea / Ceai", "p6": "🍅 Pomodoro",
    ...
    "theme.cyan": "Turcoaz", "theme.amber": "Amber", "theme.lime": "Verde lime", "theme.purple": "Mov",
    "theme.crimson": "Roșu aprins", "theme.orange": "Portocaliu", "theme.pink": "Roz", "theme.white": "Alb",
    "set.sectionTimer": "Temporizatorul rulează",
    "set.wakelock": "Menține ecranul aprins",
    "set.wakelockDesc": "Ecranul rămâne aprins cât timp rulează temporizatorul",
    "set.speakEvents": "Anunță evenimentele",
    "set.speakEventsDesc": "Anunță pornirea, pauza, continuarea și resetarea",
    "set.metronome": "Tic de metronom",
    "set.metronomeDesc": "Sunet discret în fiecare secundă",
    "set.sectionVoice": "Motorul de sinteză vocală",
    "set.voiceOutput": "Ieșire vocală",
    ...
    "sp.test": "Aceasta este o probă a vocii temporizatorului. Gata, pregătiți, start!"
  };
